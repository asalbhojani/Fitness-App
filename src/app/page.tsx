      ...
      <main className=" overflow-x-auto flex-1 bg-gradient-to-b from-[#1E1E1E] to-[#000000] uppercase">
        <div className="container px-6 lg:pt-8 pb-20 mx-auto">
          <div className="overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div className="search-input w-[100%] lg:w-[100%] relative mb-4 ">
              <div className="search-icon absolute top-[29%] left-[8px]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M21.0004 20.9999L16.6504 16.6499" stroke="#A0FC6E" stroke-width="1.5" stroke-linecap="round"
              ...
              <input
                ...
                id="grid-last-name" type="text" placeholder="your coach"></input>
            </div>

            <hr className="h-px mt-0 mb-5 bg-[#A0FC6E] border-0" />
              ...
              <div className="flex lg:flex-row flex-col">
                <div className="flex flex-col">
                  <div className="relative overflow-x-auto">
                    <table className="w-[55rem] font-light text-left rtl:text-right ">
                      <thead className="text-md text-white  bg-[#000000]">
                        <tr>
                          <th scope="col" className="px-6 py-3">Name</th>
                          <th scope="col" className="px-0 py-3">Renewal rate</th>
                          <th scope="col" className="px-0 py-3">
                            Customers followed
                          </th>
                          <th scope="col" className="px-0 py-3">Lost customers</th>
                    ...
                    <div className="relative p-4 w-[30rem] max-w-2xl max-h-full">
                      ...
                      <div className="relative bg-gradient-to-b from-[#1E1E1E] to-[#000000]">
                        ...
                        <div className="p-4 md:p-5 space-y-4">
                          ...
                          <input
                            className="placeholder-[#585858] appearance-none block w-full bg-transparent text-[#54545A] text-[14px] font-[300] border-b-3.5 border-t-0 border-l-0 border-r-0 border-[#585858] rounded-[0px] py-3 px-9 leading-tight outline-none focus:bg-transparent focus:border-[#585858] focus:ring-0"
                            id="grid-last-name" type="text" placeholder="John Doe" />
                        </div>

                        <div className="p-4 md:p-5 space-y-4">
                          <label className="text-white px-5 py-5 text-2xl">Email</label>
                          <input
                            className="placeholder-[#585858] appearance-none block w-full bg-transparent text-[#54545A] text-[14px] font-[300] border-b-3.5 border-t-0 border-l-0 border-r-0 border-[#585858] rounded-[0px] py-3 px-9 leading-tight outline-none focus:bg-transparent focus:border-[#585858] focus:ring-0"
                            id="grid-last-name" type="email" placeholder="johndoe@gmail.com" />
                        </div>

                        <div className="p-4 md:p-5 space-y-4">
                          <label className="text-white px-5 py-5 text-2xl">Password</label>
                          <input
                            className="placeholder-[#585858] appearance-none block w-full bg-transparent text-[#54545A] text-[14px] font-[300] border-b-3.5 border-t-0 border-l-0 border-r-0 border-[#585858] rounded-[0px] py-3 px-9 leading-tight outline-none focus:bg-transparent focus:border-[#585858] focus:ring-0"
                        ...
                        <div className="p-4 md:p-5 space-y-4">
                          <label className="text-white px-5 py-5 text-2xl">Assign To</label><br />
                          <select className="bg-transparent border-[#A0FC6E] text-white ml-5">
                            <option className="bg-black border-black text-white checked:bg-black">
                              athlete 1
                            </option>
                            <option className="bg-black border-black text-white checked:bg-black">
                              athlete 2
                        ...
                        <div className="flex items-center p-4 md:p-5 w-full">
                          <button type="button"
                            ...
                            <span className="text-black ml-5 font-bold">Save</span>
                          </button>
                        </div>
                      </div>
                    </div>
                ...
                <div
                  ...
                  <h1 className="text-white px-5 py-5 text-2xl">
                    Activty Calender
                  </h1>
                  <hr className="h-px my-0 mx-3 bg-[#585858] border-0" />
                      ...
                      <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_139_7571)">
                          <path
                            ...
                            fill="#F6F6F6" />
                          <rect x="4.58398" y="10.0981" width="4.36719" height="4.36719" rx="2.18359" fill="#F6F6F6" />
                        </g>
                        <defs>
                  ...
                  <hr className="h-px my-5 mx-3 bg-[#585858] border-0" />
            ...
            <div className="lg:hidden h-[100%] pb-20">
              <div className="flex lg:flex-row flex-col h-[100%] ">
                <div className="relative overflow-x-auto h-[100%] ">
                  <select className="bg-transparent border-[#A0FC6E] h-[100%] text-white">
                    <option className="bg-black border-black text-white checked:bg-black">
                      Filter By:TAG1
                    </option>
                    <option className="bg-black border-black text-white checked:bg-black">
                  ...
                  <select className="bg-transparent border-[#A0FC6E] text-white">
                    ...
                    <option className="bg-black border-black text-white checked:bg-black" selected>
                      Sort By:TAG2
                    </option>
                    <option className="bg-black border-black text-white checked:bg-black">
                      Sort By:TAG3
                ...
                <div
                  className="relative overflow-x-auto w-[20rem] h-[100%] pb-10 bg-gradient-to-b from-[#1E1E1E] to-[#000000] ml-0 mt-4">
                  <h1 className="text-white px-5 py-5 text-2xl">COACH 1</h1>

                  <button type="button"
                    className="text-white bg-[#0441B1] font-medium rounded-md text-sm px-4 py-1.5 me-2 mb-2 ml-5">
                    Tag1
                  </button>
                  <button type="button"
                    className="text-white bg-[#0441B1] font-medium rounded-md text-sm px-4 py-1.5 me-2 mb-2">
                    Tag2
                  </button>
                  ...
                  <div className="activity1">
                        ...
                        <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <defs>
                            <clipPath id="clip0_2198_8291">
                              <rect width="48" height="48" fill="white" transform="matrix(-1 0 0 -1 48.7153 48.7705)" />
                            </clipPath>
                          </defs>
                        </svg>
                      </div>
                    ...
                    <div className="flex flex row mt-2 ml-5">
                      ...
                      <span className="text-[#8F8F8F] text-lg pl-2 pt-0">25%</span>
                      <span className="text-white text-lg pl-5">Lost Customers</span>
                ...
                <div
                  className="relative overflow-x-auto w-[20rem] h-[100%] pb-10 mt-10 bg-gradient-to-b from-[#1E1E1E] to-[#000000] ml-0 mt-4">
                  <h1 className="text-white px-5 py-5 text-2xl">COACH 1</h1>
